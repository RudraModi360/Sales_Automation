...
def convert_to_serializable(obj:dict)->dict:
...
def filter_data(df:pd.DataFrame)->dict:
    filters={}
    ...
    serialized_filters = convert_to_serializable(filters)
    cleaned_filters = clean_nones(serialized_filters)
